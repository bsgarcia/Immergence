function [rep time]=askForExchange(this,othertype,othergood,confirm)
            if nargin<4; confirm=-1; end;
            texts={'Souhaitez-vous échanger votre bien en stock' 'contre celui de l’autre joueur?'}; textcolor=this.black;
            if confirm>-1
                reponses={'non' 'oui'};
                texts={strcat('Vous avez répondu “',reponses{confirm+1},'”, souhaitez-vous') 'confirmer votre choix?'}; textcolor=this.orange;
            end
