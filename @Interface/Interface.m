classdef Interface <handle
    ...
    properties (Hidden)
        ...
        Images=struct;
        fontsize=0;
        magenta=[]; cmagenta=[]; cyan=[]; yellow=[]; black=[]; white=[]; gray=200; orange=[255 150 80];
        colors=[];
        alreadyLaunched=0;
    ...
    methods
        function this=Interface(type,debugmode)
            ...
            this.type=type; this.debug=debugmode;
            this.initializeWindow;
            if ismac
                this.rightCode=79; this.leftCode=80;
            end
            %KbWait;
            if (debugmode==0); Screen('Flip',this.window); end;
        end
        ...
        function initializeWindow(this)
            ...
            this.black=BlackIndex(this.window); this.white=WhiteIndex(this.window);
            load('Images','Images');
            this.Images=Images;            
