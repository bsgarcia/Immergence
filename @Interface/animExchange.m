        function animExchange(this,othertype,othergood)
            ...
            nloop=0;
                ...
                goodChanged=0;
                textAnswer='L’autre joueur souhaite aussi réaliser l’échange'; textcolor=this.orange; drawtextsize=round(this.fontsize*0.9);
            ...
            while initialDistance>-distance
                ...
                if initialDistance/2<-distance && ~goodChanged
                    ...
                    if this.useHeader; this.drawHeader(othergood); end;
                    offset=offset+offsetLength;
