...
if nargin<4; R=struct; end;
if length(fieldnames(R))==0; R.lastRound=0; R.lastGame=1; end; %#ok<ISMT>
this.resetScreen;
startSecs=GetSecs();
...
verb='stocker';
if strcmp(costword,'production'); verb='produire'; end;
if strcmp(costword,'stockage et production'); verb='produire et stocker'; end;
...
timenextmess='';
if this.useIntervalEverythere; timenextmess=sprintf(' dans %u secondes',this.intervalValueIfUsed); end;
message_line4=['La manche suivant va commencer' timenextmess];
if R.lastGame; message_line4=['Les jeux sont términés. L''écran suivant affichera votre gain' timenextmess]; end;
