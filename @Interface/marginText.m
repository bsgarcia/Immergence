function textrect = marginText(this, text, marginLeft, marginTop, textsize, color, rect)
    ...
    elseif ischar(marginLeft) && ~ischar(marginTop);
        textrect = AlignRect(textrect, rect, marginLeft);
    elseif ~ischar(marginLeft) && ischar(marginTop);
        textrect = AlignRect(textrect, rect, marginTop);
    elseif ischar(marginLeft) && ischar(marginTop);
        textrect = AlignRect(textrect, rect, marginLeft, marginTop);
    end
